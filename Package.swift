...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url:
                "https://adsdkdevstand.azureedge.net/dev/mobile/mtest/adoreleasetest/9.0.0-beta.2/dynamic/OMSDK_Microsoft.zip",
            checksum: "fe6635e4d7db5d68d4cd40181664b5162bc1dcb7ba7f6fd6bb12940bdde627e3"
        ),
         .binaryTarget(
            name: "AppNexusSDKTarget",
            url:
                "https://adsdkdevstand.azureedge.net/dev/mobile/mtest/adoreleasetest/9.0.0-beta.2/dynamic/AppNexusSDKDynamic.zip",
    ...
    .binaryTarget(
      ...
      url: "https://adsdkdevstand.azureedge.net/dev/mobile/mtest/adoreleasetest/9.0.0-beta.2/static/ANGoogleAdapter.xcframework.zip",
